...
export function LetterEnvelope({
  ...
  if (stage === "open") {
    return (
      <div
        className="lobby-letter-paper lobby-letter-opening rounded-md border border-[var(--lobby-red)]/15 text-[15px] text-zinc-800 shadow-sm"
  ...
  return (
    <div className="flex flex-col items-center gap-2 pt-8">
      ...
      >
        <div className="lobby-env-back" />
        <div
          className="lobby-env-paper"
          onAnimationEnd={(e) => {
            if (e.animationName === "lobbyEnvPaper") setStage("open");
          }}
        />
        <div className="lobby-env-pocket" />
        <div className="lobby-env-flap">
